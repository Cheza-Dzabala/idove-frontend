  ...
  render() {
    return (
      <div className="control-icon more has-items">
        ...
        <div className="label-avatar bg-primary">{this.notificationCount()}</div>
        ...
        <div className="more-dropdown more-with-triangle triangle-top-center">
          ...
          <div className="mCustomScrollbar" data-mcs-theme="dark">
            {this.notificationCount() === 0 ? <div className="ui-block-content"><h6>No new notifications</h6></div> :
